...
<div class="wrap">
	...
	<form method="post" action="" class="htaccess-ss-form">
		...
		<div class="htaccess-ss-actions">
			<button type="button" id="htaccess-ss-download-btn" class="button">
				<?php esc_html_e( '.htaccess をダウンロード', 'htaccess-ss' ); ?>
			</button>

			<?php submit_button( '設定を保存して .htaccess に反映', 'primary', 'submit', false ); ?>
			<button type="button" id="htaccess-ss-preview-btn" class="button button-secondary">
				<?php esc_html_e( 'プレビュー', 'htaccess-ss' ); ?>
			</button>

			<form method="post" action="" id="htaccess-ss-reset-form" class="htaccess-ss-footer-form">
			...
			<form method="post" action="" id="htaccess-ss-delete-all-form" class="htaccess-ss-footer-form">
	...
	<div class="htaccess-ss-footer-actions">
		<?php if ( $backup_time ) : ?>
			<form method="post" action="" id="htaccess-ss-restore-form" class="htaccess-ss-footer-form">
